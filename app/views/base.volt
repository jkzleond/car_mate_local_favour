...
<!--    <link rel="stylesheet" type="text/css" href="{{ url('/assets/css/j.css') }}"/>-->
    ...
    <link rel="stylesheet" href="{{ url('/assets/css/bxjs.css?bust=5.2.14')}}"/>
    {% endblock %}
    {% block header_js %}
    <script type="text/javascript" src="{{ url('/assets/js/date.js') }}"></script>
    <script type="text/javascript" src="{{ url('/assets/js/require.js') }}" data-main="{{ url('/assets/js/app/main.js?bust=5.2.14') }}"></script>
