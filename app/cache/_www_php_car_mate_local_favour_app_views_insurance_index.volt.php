...
<div data-role="page" id="insurance_page" data-theme="a" style="padding-top:51px">
    ...
    <div role="main" class="ui-content">
                    ...
                    <td>
                        <div class="ui-field-contain">
                            <div data-role="controlgroup" data-type="horizontal">
                                ...
                                <?php } ?>
                                <input type="text" name="phone" data-theme="a" value="<?php echo $phone; ?>"/>
                            </div>
                        </div>
                    </td>
                </tr>
                        ...
                        <div class="ui-field-contain">
                            <div data-role="controlgroup" data-type="horizontal">
                                <select name="insurance_set_id">
                                    <?php foreach ($insurance_sets as $insurance_set) { ?>
                                    <option value="<?php echo $insurance_set->id; ?>" <?php if ($insurance_set->id == '3') { ?>selected<?php } ?>><?php echo $insurance_set->name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="ui-field-contain">
                            <div data-role="controlgroup" data-type="horizontal">
                                <select name="compulsory_state_id"">
                                    <?php foreach ($compulsory_states as $compulsory_state) { ?>
        ...
        <?php if ($user->user_id == 'WEIBO_ACCOUNT' || $user->user_id == 'INSURANCE_ACCOUNT') { ?>
        车友惠购险，可享最高4.9折优惠<br />
